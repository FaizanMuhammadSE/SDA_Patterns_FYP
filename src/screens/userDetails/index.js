...
import HeaderStyledButton from "../../commonComponents/HeaderStyledButton.js";
...
const index = ({navigation}) => {
    ...
    return <ScrollView>
        ...
        <Card style={styles.cardStyle} elevation={30} cornerRadius={20}>
            ...
            <HeaderStyledButton ColorValue="black" TextValue="Grades & Subjects"></HeaderStyledButton>
            <View>
            ...
            <HeaderStyledButton ColorValue="black" TextValue="Verification"></HeaderStyledButton>
            <Card style={styles.cardStyle} elevation={10} cornerRadius={20}>
                    <View style={{flexDirection:'row',justifyContent:'space-around',flexWrap:'wrap'}}>
            ...
            <HeaderStyledButton ColorValue="black" TextValue="About"></HeaderStyledButton>
            <Card style={styles.cardStyle} elevation={10} cornerRadius={20}>
            ...
            <HeaderStyledButton ColorValue="black" TextValue="Contact Details"></HeaderStyledButton>
            <Card style={styles.cardStyle} elevation={10} cornerRadius={20}>
                    <View style={{flexDirection:'row',justifyContent:'space-around',flexWrap:'wrap'}}>
